...
```bash
# 下载并运行安装脚本
bash <(curl -s https://raw.githubusercontent.com/[your-username]/term-accel/master/install.sh)
```
...
1. 克隆项目：
   ```bash
   git clone https://github.com/[your-username]/term-accel.git
   cd term-accel
   ```
...
- GitHub Issues: https://github.com/[your-username]/term-accel/issues
